...
func NewDispatcher(incomingCh <-chan message2.Task, vdRepository repository.VDRepository, codec codec.Codec, sender sender.Sender, numWorkers int) *Dispatcher {
	return &Dispatcher{

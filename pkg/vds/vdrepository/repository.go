...
type VDRepository interface {
	GetVDStateById(ctx context.Context, id string) (attribute.Flag, error)       // 根据 ID 查找虚拟设备状态信息
	GetAllVDStates(ctx context.Context) (map[string]attribute.Flag, error)       // 找到所有在线设备状态信息
